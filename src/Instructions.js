...
const Instructions = () => {
    return (
        <section className="instructionsSection">
            ...
            <p>1. Enter your library and select a radius to set the search area.</p>
            <p>2. A map will appear with a list of 10 coffee shops around the library.</p>
            <p>3. Select your preferred coffee shop from the list and choose a mode of transportation (default is drive) to get directions.</p>
        </section>
    )
};
